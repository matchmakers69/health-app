...
function CloseSidebarButton({ onClose }: CloseSidebarButtonProps) {
	return (
		<button
			type="button"
			className="close-menu inline-flex h-[3rem] cursor-pointer items-center text-[13px] uppercase tracking-[.15rem] text-gray-200 focus:outline-none focus-visible:ring-1 focus-visible:ring-foreground-green focus-visible:ring-offset-0"
			onClick={onClose}
		>
