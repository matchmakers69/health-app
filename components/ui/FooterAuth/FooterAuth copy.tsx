				...
				<div className="">
					<span className="flex w-full items-center justify-center">
						...
						<Button
							...
							type="button"
							className="inline-block rounded-full border-2 border-neutral-50 bg-transparent px-6 pb-[6px] pt-2 text-base font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:border-neutral-100 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-neutral-100 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200"
						>
